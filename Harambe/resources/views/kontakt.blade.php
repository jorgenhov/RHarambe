...
@section('stylesheet') <link rel="stylesheet" type="text/css" href="css/kontakt.css"> @stop
@section('script') <script src="http://maps.googleapis.com/maps/api/js"></script> @stop
@section('script')
<script>
function initialize() {
  var mapProp = {
  ...
  var contentString = '<div id="content">'+'<h3>Marina Solutions</h3>'+'</div>';
