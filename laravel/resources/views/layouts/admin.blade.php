...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Harambe admin panel</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="{{ route('admin.index') }}"><i class="fa fa-dashboard fa-fw"></i>Hoved panel</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.tables') }}"><i class="fa fa-table fa-fw"></i>Tabeller</a>
                    </li>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
