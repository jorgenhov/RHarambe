...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <form method="post" action="{{ route('order.reservation') }}">
                        ...
                        <tbody>
                            ...
                            @foreach ($available as $availableTable) 
                                <tr>
                                    ...
                                    <td class="actions" data-th="">
                                        <a href="{{ route('shop.reservation',['id' => $availableTable->tableID]) }}" class="btn btn-success btn-lg" style="margin-top:10px;">Legg til</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
